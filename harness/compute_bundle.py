...
def build_source_bundle(
    ...
    *,
    ...
    """Build a bounded, hash-addressed ZIP bundle without following symlinks."""
...
def extract_source_bundle(
    ...
    *,
    ...
    """Verify and extract a source bundle while rejecting traversal and symlinks."""
    ...
    try:
        ...
        raise ValueError("invalid source bundle base64") from exc
    ...
    if expected_content and not hmac.compare_digest(actual_content, expected_content):
